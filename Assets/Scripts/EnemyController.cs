...
{   
    ...
    {
        bool isOutRightBoundary = _isFacingRight && transform.position.x >= _rightBoundaryPosition.x;
        bool isOutLeftBoundary = !_isFacingRight && transform.position.x <= _leftBoundaryPosition.x;
